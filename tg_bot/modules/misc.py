...
RUN_STRINGS = (
    ...
    "taltal!!",
    "Fugg off!",
    "Eto ay pang tao lang, kaya umalis kana.",
    "Ang group na ito ay hindi nababagay sayo.",
    "SHU! ALES!",
    "bat kaba takbo ng takbo?",
    ";______________________;",
    "But whoi sar? Pangit mo.",
    "Di ka nakakatawa.",
    "Seryoso ka?",
    "Okay sige takbo.",
    "Takbo ka sa mama mo.",
    "Oof, sick b8 m8",
    "( ͡° ͜ʖ ͡°)( ͡° ͜ʖ ͡°)",
    "This one is just to annoy @The6thHokage03 ;)",
    "Pakamatay kana. Please.",
    "ＨＡＪＩＭＥ says no!",
    "NoU∞.",
    "Well… Ambaho ng hininga mo. "
    "Weeeeeeeeeeew",
    "Obvious ba?",
    "ADVANCE KABA MAG ESEP? JEJEJEJEJE",
    "Pangit mo sige takbo.",
    "Delete des sar or baban kita.",
    "Yeah yeah, tap mo tong /kickme",
    "Sige alis kana, wag ka ng babalik. SALAMAT!",
    "Di ako makapaniwala na nasabi mo yan GE TAKBO.",
    "Can you not.",
    "UwU.",
    "OwO",
    "When in doubt annoy @The6thHokage03 :P",
    "Sige lang gawin mo gusto mong gawin, Sana ma-ban ka.",
    ...
    "Non't Urselfn't.",
    "Panget papa mo.",
    "Kaya di tayo sinasakop ng alien.",
    "Celpon paaaaa.",
    "Sige exercise ka jan sar.",
    "I am the　ｂｏｉ！ Walang tatakbo saken.",
    "ＨＡＪＩＭＥ demands you walk and not run!",
)
